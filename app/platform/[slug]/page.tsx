      ...
      <main className="flex-1 pt-24 pb-16">
        ...
        <section className="container mx-auto px-6 py-12 text-center">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-6xl mb-6">
            Platform: <span className="text-primary">{page.title}</span>
          </h1>
          ...
          <div className="flex justify-center gap-4">
            ...
            <Button size="lg" variant="outline" asChild>
              <Link href="/product">View Documentation</Link>
            </Button>
          </div>
        </section>
              ...
              <Card key={index} className="bg-background border-none shadow-md hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Advanced {feature.toLowerCase()} capabilities designed for enterprise scale and reliability.
                  </p>
                </CardContent>
              </Card>
            ))}
          ...
          <div className="rounded-3xl bg-primary px-6 py-16 text-center text-primary-foreground md:px-12 relative overflow-hidden">
            <div className="relative z-10">
              <h2 className="text-3xl font-bold tracking-tight sm:text-4xl mb-4">
                Ready to build with {page.title}?
              </h2>
              <p className="mx-auto max-w-xl text-lg opacity-90 mb-8">
                Join leading agricultural enterprises using our platform to power their operations.
              </p>
